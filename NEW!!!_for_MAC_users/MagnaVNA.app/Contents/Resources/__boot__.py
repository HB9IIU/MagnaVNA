...
_recipes_pil_prescript(['McIdasImagePlugin', 'PdfImagePlugin', 'WebPImagePlugin', 'GribStubImagePlugin', 'TiffImagePlugin', 'MicImagePlugin', 'DdsImagePlugin', 'Hdf5StubImagePlugin', 'BlpImagePlugin', 'FpxImagePlugin', 'JpegImagePlugin', 'PpmImagePlugin', 'IcoImagePlugin', 'PcxImagePlugin', 'QoiImagePlugin', 'IcnsImagePlugin', 'PixarImagePlugin', 'GifImagePlugin', 'FtexImagePlugin', 'XbmImagePlugin', 'Jpeg2KImagePlugin', 'SunImagePlugin', 'SpiderImagePlugin', 'BmpImagePlugin', 'GbrImagePlugin', 'WmfImagePlugin', 'MpoImagePlugin', 'XVThumbImagePlugin', 'MspImagePlugin', 'PcdImagePlugin', 'MpegImagePlugin', 'EpsImagePlugin', 'SgiImagePlugin', 'ImImagePlugin', 'TgaImagePlugin', 'PngImagePlugin', 'FitsImagePlugin', 'BufrStubImagePlugin', 'IptcImagePlugin', 'DcxImagePlugin', 'CurImagePlugin', 'PsdImagePlugin', 'PalmImagePlugin', 'XpmImagePlugin', 'FliImagePlugin', 'ImtImagePlugin'])
