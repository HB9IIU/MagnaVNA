...
_recipes_pil_prescript(['MicImagePlugin', 'FpxImagePlugin', 'McIdasImagePlugin', 'GifImagePlugin', 'PcxImagePlugin', 'TgaImagePlugin', 'QoiImagePlugin', 'SgiImagePlugin', 'BmpImagePlugin', 'FitsImagePlugin', 'PsdImagePlugin', 'PcdImagePlugin', 'BufrStubImagePlugin', 'ImtImagePlugin', 'IcoImagePlugin', 'CurImagePlugin', 'JpegImagePlugin', 'XpmImagePlugin', 'MspImagePlugin', 'GbrImagePlugin', 'MpegImagePlugin', 'XbmImagePlugin', 'IcnsImagePlugin', 'PpmImagePlugin', 'EpsImagePlugin', 'WebPImagePlugin', 'FtexImagePlugin', 'Hdf5StubImagePlugin', 'FliImagePlugin', 'SpiderImagePlugin', 'PdfImagePlugin', 'PngImagePlugin', 'DcxImagePlugin', 'MpoImagePlugin', 'DdsImagePlugin', 'TiffImagePlugin', 'Jpeg2KImagePlugin', 'SunImagePlugin', 'ImImagePlugin', 'GribStubImagePlugin', 'PixarImagePlugin', 'PalmImagePlugin', 'WmfImagePlugin', 'BlpImagePlugin', 'XVThumbImagePlugin', 'IptcImagePlugin'])
